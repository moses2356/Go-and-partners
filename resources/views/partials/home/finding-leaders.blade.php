...
<main id="finding-leaders"
    class="relative min-h-screen flex flex-col md:flex-row items-stretch bg-background-light dark:bg-background-dark">
    <div
    ...
    <div class="w-full md:w-1/2 relative overflow-hidden min-h-[500px] md:min-h-screen z-0">
        <div class="absolute inset-0">
            <img alt="Finding your leader image" class="w-full h-full object-cover object-left grayscale-[20%]"
                src="{{ asset('images/find your leader.webp') }}" />
