        ...
        <div class="relative flex justify-center lg:justify-end items-center" data-reveal="reveal-up"
            ...
            <div
                ...
                <div class="text-white flex flex-col items-center justify-center w-full h-full">
                    ...
                    <div
                        class="mb-2 md:mb-4 p-2 md:p-4 rounded-full border-[3px] border-secondary text-secondary bg-primary/80 shadow-[0_0_20px_rgba(98,196,201,0.4)]">
                        <span class="material-icons-outlined hero-icon-heart">favorite</span>
                    </div>
                    <div class="flex items-end -space-x-3 md:-space-x-5">
                        <span
                            class="material-icons-outlined hero-icon-side opacity-70 transform -translate-y-1 md:-translate-y-2">person</span>
                        <span
                            class="material-icons-outlined hero-icon-center z-10 text-white drop-shadow-[0_15px_15px_rgba(0,0,0,0.6)]">person</span>
                        <span
                            class="material-icons-outlined hero-icon-side opacity-70 transform -translate-y-1 md:-translate-y-2">person</span>
                    </div>
                </div>
